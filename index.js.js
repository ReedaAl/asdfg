  ...
  message.channel.send(embed);
   ...
   //WESO#0001  //WESO#0001  //WESO#0001  //WESO#0001  //WESO#0001
    ...
    if(args[1] && args[1] === 'stats') {
      ...
      let embed = new Discord.RichEmbed()  //WESO#0001
        ...
        .setDescription(`سيرفر || \`${clan.toString()}\``)  //WESO#0001
        embed.addField('» اسم سيرفر', clan, true)  //WESO#0001
        embed.addField('» تاريخ عمل سيرفر', clans[clan].createdAt, true);  //WESO#0001
        embed.addField('» تاريخ دخول سيرفر', system[author.id].joinedAt, true)  //WESO#0001
        embed.addField('» صاحب سيرفر', `<@${clans[clan].creator}>`, true);  //WESO#0001
        embed.addField('» لفل سيرفر', clans[clan].level, true);  //WESO#0001
        embed.addField('» عدد اعضاء سيرفر', clans[clan].members.length, true);  //WESO#0001
        embed.addField('» عدد التقديمات ل سيرفر', clans[clan].applylist.length, true);  //WESO#0001
        embed.addField('» عدد الادمنية بالسيرفر', clans[clan].admins.length, true);  //WESO#0001
        embed.addField('» اعضاء سيرفر', `${prefix}clan list || يظهرلك رسالة بها اعضاء سيرفر`);  //WESO#0001
   ...
   //WESO#0001
    ...
    if(args[1] && args[1] === 'rename') {
      ...
      let m = await message.channel.send(`**# \`${c}\`, هل أنت متأكد من تغيير اسم السيرفر \n\n - للتأكيد \`نعم\`\n - للرفض \`لا\`**`);
      let awaiting = await message.channel.awaitMessages(r => r.author.id === message.author.id, {max: 1, time: 20000, errors: ['time']}).then(c => {
        ...
        if(collected.content === 'نعم') {
          ...
          system[author.id].clan = newName;
            ...
            message.channel.send("**# تم تغيير اسم سيرفر بنجاح**");
 
        } else if(collected.content === 'لا') {
          message.channel.send(`**# \`${newName}\`, تم الغاء تغيير اسم سيرفر**`);
